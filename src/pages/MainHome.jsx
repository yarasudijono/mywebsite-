...
function Home(){
    return(
        ...
        <div>
            <p id="intro1">i'm yara, and i'm currently a first-year at barnard college of columbia university intending to study economics and film. i was born and raised in jakarta, indonesia, and if i'm not getting lost in transit trying to get to a new restaurant spot, i'm probably in bed binging video essays.</p>
        </div>    
        <div>
            <p id="intro2">before college, i spent a gap year in jakarta furthering my advocacy for sustainable fashion through hosting city-wide Apparel Swaps with my non-profit organization, Your Clothes, as well as exploring film and media as a freelance production designer and storyboard artist. i hope to keep pursuing projects at the intersection of art, sustainability, and equity through entrepreneurship.</p>
        </div>
