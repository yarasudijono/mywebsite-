...
function Home(){
    return(
        ...
        <div>
            <p id="intro1">i'm yara, and i'm currently a sophomore at barnard college of columbia university intending to study economics with a minor in english. i was born and raised in jakarta, indonesia, and if i'm not getting lost in transit trying to get to a new restaurant spot, i'm probably in bed binging video essays.</p>
        </div>    
        <div>
